...
class PagesController extends Controller
{
    ...
    public function noticia11()
    {
        ...
        return view('layouts.blog.blog11')->with($datos); 
    }
    public function Mensaje05()
    {
        //Formulario
            //Saltillo
                $BachSaltillo = Programa::with('Campus', 'modalidadPrograma', 'tipoPrograma')
        ...
        return view('layouts.blog.Mensaje05-03-2020')->with($datos); 
    }
    public function Mensaje0204()
    {
        //Formulario
            //Saltillo
                $BachSaltillo = Programa::with('Campus', 'modalidadPrograma', 'tipoPrograma')
        ...
        return view('layouts.blog.Mensaje 02-04-2020')->with($datos); 
    }
}
