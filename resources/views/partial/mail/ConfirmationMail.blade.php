                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-dark o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #73243d;color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 24px;">
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Puedes darle seguimiento al estatus de la solicitud con este id :<b></b></p>
                                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="384" class="o_bg-ultra_light o_br o_text-md o_sans o_px-xs o_py-md" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;border-radius: 4px;padding-left: 8px;padding-right: 8px;padding-top: 24px;padding-bottom: 24px;">
                                                                    <p class="o_text-dark" style="color: #242b3d;margin-top: 0px;margin-bottom: 0px;"><strong>{{ $designRequestData['id'] }}</strong></p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
