                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-primary o_px o_py-md o_br-t o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #fff;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                                    ...
                                    <p><h2 style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 30px;line-height: 39px;">Convenio registrado</h2></p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Puedes darle seguimiento a la ficha de tu convenio con este id : <strong>{{ $convenio['id'] }}</strong></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <tbody>
            <tr>
                <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                    <!--[if mso]><table width="632" cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td><![endif]-->
                        <img src="{{ asset('multi/images/convenios/MailingConvenios.jpg') }}" alt="SimpleApp">
                </td>
            </tr>
        </tbody>
    </table>
