                    ...
                    <table border-collapse: separate; style>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th><a href="{{ route('usuarios.FlyersMat') }}">Carreras</a></th>
                          <td>7 elementos</td>
                        </tr>
                        <tr>
                          <td><a href="{{ route('usuarios.PostgradosMat') }}"><img src="{{ asset('/multi/images/vector.jpg') }}"  /></a></td>
                          <th><a href="{{ route('usuarios.PostgradosMat') }}">Postgrados</a></th>
                          <td>4 elementos</td>
                        </tr>
                        <tr>
                          <td><a href="{{ route('usuarios.PreciosMat') }}"><img src="{{ asset('/multi/images/vector.jpg') }}"  /></a></td>
                          <th><a href="{{ route('usuarios.PreciosMat') }}">Precios</a></th>
                          <td>2 elementos</td>
                        </tr>
                        <tr>
