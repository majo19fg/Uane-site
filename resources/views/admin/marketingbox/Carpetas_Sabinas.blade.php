                ...
                <div class="col-md-4">
                    ...
                    <table border-collapse: separate; style>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><a href="{{ route('usuarios.CarrerasSab') }}"><img src="{{ asset('/multi/images/vector.jpg') }}"  /></a></td>
                          <th><a href="{{ route('usuarios.CarrerasSab') }}">Carreras</a></th>
                          <td>5 elementos</td>
                        </tr>
                        <tr>
                          <td><a href="{{ route('usuarios.PreciosSabinas') }}"><img src="{{ asset('/multi/images/vector.jpg') }}"  /></a></td>
                          <th><a href="{{ route('usuarios.PreciosSabinas') }}">Precios</a></th>
                          <td>2 elementos</td>
                        </tr>
                        <tr>
