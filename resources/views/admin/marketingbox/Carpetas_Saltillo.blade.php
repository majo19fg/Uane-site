                    ...
                    <table border-collapse: separate; style>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th><a href="{{ route('usuarios.FlyersCoah') }}">Carreras</a></th>
                          <td>17 elementos</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><a href="{{ route('usuarios.PreciosSW') }}"><img src="{{ asset('/multi/images/vector.jpg') }}"  /></a></td>
                          <th><a href="{{ route('usuarios.PreciosSW') }}">Precios</a></th>
                          <td>2 elementos</td>
                        </tr>
                        <tr>
