...
<div class="br-pageheader">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Acceso</span>
  </nav>
</div><!-- br-pageheader -->
...
<div class="br-pagetitle">
    ...
    <div>
      <h4>Acceso</h4>
      <p class="mg-b-0">Lista completa de accesos al marketing box.<br></p>
    </div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">      
    ...
    <div class="row">
        <div class="col-md-6">
            <h6 class="br-section-label">Accesos a Marketing box</h6>
        </div>
        <div class="col-md-6">
            <a href="{{ route('exportar.acceso') }}" class="btn btn-primary btn-block tx-15 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-large" >Exportar tabla a excel</a>
        </div>
    </div>
      ...
      <table id="datatable1" class="table display responsive nowrap" style="width:100%;">
        <thead>
          <tr>
            ...
            <th class="wd-15p">Fecha de modificación</th>
          </tr>
        </thead>
        <tbody>
        @foreach ($acceso as $acceso)
          <tr >
              <td>{{ $acceso->campus}}</td>
              <td>{{ $acceso->created_at }}</td>
              <td>{{ $acceso->updated_at }}</td>
          </tr>
        @endforeach
