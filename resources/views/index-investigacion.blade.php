            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class="text-center mb-30 p-10">
                <a href="{{ route('programas.index') }}" class="">
                  <img src="/multi/images/flaticon-png/investigacion/libro.png" width="70" alt="">
                </a>
                <h4 class="font-weight-600 mt-20">Tesis de doctorado DPyLE</h4>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class="text-center mb-30 p-10">
                <a href="https://www.redlatinoamerica.org/" class="">
                  <img src="/multi/images/flaticon-png/investigacion/latinoamerica.png" width="70" alt="">
                </a>
                <h4 class="font-weight-600 mt-20">Red Latinoamericana de investigación con la Universidad de Siena, César Vallejo Perú, UAdeC, Distrital José Caldas</h4>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class="text-center mb-30 p-10">
                <a href="#" class="">
                  <img src="/multi/images/flaticon-png/investigacion/investigacion.png" width="70" alt="">
                </a>
                <h4 class="font-weight-600 mt-20">Memoria de la investigación</h4>
              </div>
            </div>
                        ...
                        <div class="item">
                          ...
                          <div class="item">
                            <article class="post clearfix maxwidth600 mb-sm-30">
                              ...
                              <div class="entry-content bg-white border-1px p-20">
                                ...
                                <p class="text-left mb-20 mt-15 font-13"> Mafer Ortíz es egresada de la Licenciatura en Comunicación y trabaja actualmente en Multimedios como conductora de TV y locutora de Radio.
                          ...
                          <div class="item">
                              <article class="post clearfix maxwidth600 mb-sm-30">
                                <div class="entry-header">
                                    <div class="video-popup">                
                                        <a href="https://www.youtube.com/embed/_-j9GOu_C-M" data-lightbox-gallery="youtube-video" title="Video">
                                          <img alt="" src="/multi/images/exauane/Fidencio.jpg" class="img-responsive img-fullwidth">
                                        </a>
                                      </div>       
                                </div>
                                <div class="entry-content bg-white border-1px p-20">
                                  <h5 class="entry-title mt-0 pt-0"><a href="#">Fidencio González - Atleta de la selección mexicana</a></h5>
                                  <p class="text-left mb-20 mt-15 font-13">Fidencio González es egresado de la Licenciatura en Psicologia, actualmente participó en los juegos panamericanos en Lima Peru.</p>
                                  <a class="btn btn-flat btn-dark btn-theme-colored btn-sm pull-left" href="https://www.youtube.com/embed/_-j9GOu_C-M">Ver más</a>
                                  <ul class="list-inline entry-date pull-right font-12 mt-5">
                                    <li><span class="text-theme-colored">Oct 1, 2019</span></li>
                                  </ul>
                                  <div class="clearfix"></div>
                                </div>
                              </article>
